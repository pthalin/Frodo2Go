...
static SDLKey keys[2][NUM_ROWS][NUM_KEYS] = {
  {
    {SDLK_1, SDLK_2, SDLK_3, SDLK_4, SDLK_5, SDLK_6, SDLK_7, SDLK_8,     SDLK_9,      SDLK_0,     SDLK_PLUS,     SDLK_MINUS,  SDLK_END, SDLK_x,    SDLK_F1},
    {SDLK_q, SDLK_w, SDLK_e, SDLK_r, SDLK_t, SDLK_y, SDLK_u, SDLK_i,     SDLK_o,      SDLK_p,     SDLK_x,        SDLK_x,      SDLK_x, SDLK_DELETE, SDLK_F3},
    {SDLK_a, SDLK_s, SDLK_d, SDLK_f, SDLK_g, SDLK_h, SDLK_j, SDLK_k,     SDLK_l,      SDLK_COLON, SDLK_SEMICOLON,SDLK_EQUALS,  SDLK_x, SDLK_x,     SDLK_F5},
    {SDLK_z, SDLK_x, SDLK_c, SDLK_v, SDLK_b, SDLK_n, SDLK_m, SDLK_COMMA, SDLK_PERIOD, SDLK_SLASH, SDLK_UP,       SDLK_SPACE, SDLK_LCTRL,           SDLK_F7},
    {SDLK_x, SDLK_SPACE, SDLK_LEFT, SDLK_DOWN, SDLK_RIGHT,   SDLK_RSHIFT, SDLK_RCTRL}
  }, {
    {SDLK_EXCLAIM,SDLK_QUOTEDBL,SDLK_HASH,SDLK_DOLLAR,SDLK_F15,SDLK_AMPERSAND,SDLK_QUOTE,SDLK_LEFTPAREN,SDLK_RIGHTPAREN,SDLK_0,SDLK_PLUS,SDLK_MINUS,SDLK_END,SDLK_x,SDLK_F2},
    {SDLK_q, SDLK_w, SDLK_e, SDLK_r, SDLK_t, SDLK_y, SDLK_u, SDLK_i,     SDLK_o,      SDLK_p,     SDLK_x,        SDLK_x,     SDLK_x, SDLK_DELETE, SDLK_F4},
    {SDLK_a, SDLK_s, SDLK_d, SDLK_f, SDLK_g, SDLK_h, SDLK_j, SDLK_k,     SDLK_l,      SDLK_COLON, SDLK_SEMICOLON,SDLK_EQUALS,SDLK_x, SDLK_x,      SDLK_F6},
    {SDLK_z, SDLK_x, SDLK_c, SDLK_v, SDLK_b, SDLK_n, SDLK_m, SDLK_COMMA, SDLK_PERIOD, SDLK_SLASH, SDLK_UP,       SDLK_SPACE, SDLK_LCTRL,          SDLK_F8},
    {SDLK_x, SDLK_SPACE, SDLK_LEFT, SDLK_DOWN, SDLK_RIGHT,   SDLK_RSHIFT, SDLK_RCTRL}
  }
};
...
int handle_keyboard_event(SDL_Event* event) {
	...
	if(event->key.type  == SDL_KEYDOWN &&
	  ...
	  if(event->key.keysym.sym == KEY_UP && selected_j > 0) {
	    ...
	    */
	    //SIFT
	    if(mod_state & KMOD_SHIFT && key >= SDLK_a && key <= SDLK_z) {
